...
@router.post("/api/medical-consultation")
...
@router.get("/api/farmacia/orders")
...
@router.patch("/api/farmacia/orders/{order_id}")
...
@router.post("/api/prescriptions/{order_id}/sign")
...
@router.post("/api/auth/biometric")
